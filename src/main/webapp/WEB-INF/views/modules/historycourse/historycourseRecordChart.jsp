...
<head>
	<title>课程图表</title>
	<title>${historycourse.teachername} - ${historycourse.coursename}</title>
	<meta name="decorator" content="default"/>
	<script src="${ctxStatic}/modules/course/historycourserecord.js" type="text/javascript"></script>
	<script>
		$(function(){
			drawAllRecordData('${ctx}', '${historycourse.id}');
		});
	</script>
</head>
<body>
	<table style="width:100%;">
		<tr>
             <td style="text-align:center;">
                 <br/>
                 <h3>${historycourse.coursename} - ${historycourse.teachername}</h3> 
             </td>
        </tr>
		<tr>
			<td>
